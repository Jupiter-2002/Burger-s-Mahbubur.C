...
<html>
	...
	$this->load->view('admin/common/head_segment',$dataHead);
	?>
	<body>
		<?php
		...
		*/
		...
		<div id="rightSide">
			<?php
			//	Right Side Top NAV
			$this->load->view('admin/common/top_nav_Menu');

			if( isset($respnsHeader) && $respnsHeader != "" ) {
				$this->load->view($respnsHeader);
			} else {
				$this->load->view('admin/common/respns_header_basic');
			}
			...
			if( isset($headerIconSliderPage) && $headerIconSliderPage != "" ) {
				...
				$this->load->view('admin/common/headerIconSliderBasic');
			}
			...
			$this->load->view('admin/common/top_heading', $arr_top_heading_data);
