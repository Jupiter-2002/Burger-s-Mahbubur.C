...
<div class="topNav">
	<div class="wrapper">
		...
		<div class="userNav">
			<ul>
				<li class="redBackOnly" ><a href="<?php echo base_url().'dashboards';	?>" title=""><img src="<?php echo asset_url();?>dist/images/icons/topnav/tasks.png" alt="" /><span><b>HOME</b></span></a></li>
