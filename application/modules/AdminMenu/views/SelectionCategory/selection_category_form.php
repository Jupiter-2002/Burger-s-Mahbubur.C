...
$triggerFunc = "ajaxAddSelectionCategory()";

if( isset($ObjectDetails) && is_array($ObjectDetails) ) {
    $SelecCatName = $ObjectDetails[0]->SelecCatName;

    $triggerFunc = "ajaxUpdateSelectionCategory(".$ObjectDetails[0]->PK_SelecCatId.")";
}
?>
...
<fieldset>
    <div class="oneTwo">
        <div class="formRow">
            <label>Name:</label>
            <div class="formRight"><input name="SelecCatName" id="SelecCatName" type="text" value="<?php echo $SelecCatName;   ?>"></div>
            <div class="clear"></div>
        </div>
    </div>
