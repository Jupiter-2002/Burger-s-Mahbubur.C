...
<div class="widget">
    ...
    <div class="oneThree">
        <div class="formRow">
            <a href="javascript:void(0);" title="" class="wButton greenwB" onclick="saveToppingToBase(<?= $BaseDetails[0]->PK_BaseId;  ?>)"  style="color: white; height: 27px; line-height: 27px; float: left;" ><span>SAVE</span></a>
        </div>
    </div>
</div>
