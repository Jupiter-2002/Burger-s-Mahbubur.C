            ...
            if( isset($arrCategoryList) && is_array($arrCategoryList) ) {
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        ...
                        <a href="javascript:void(0);"  title="" class="wButton greenwB" style="color: white; height: 24px; line-height: 24px; float: left; margin-left: 15px;" onclick="loadToppingByCategoryForm(<?= $BaseItemDetails[0]->PK_BaseId;  ?>)" ><span>LOAD</span></a>
