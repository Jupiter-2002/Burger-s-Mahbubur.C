...
<div class="widget">
    ...
    <div class="title">
        ...
        <h6 style="padding: 11px;">Topping List</h6>


        <div style="float: right; padding: 11px;">
            <a href="javascript:void(0);" class="tipS" original-title="Update" title="EDIT ITEM" onclick="loadToppingBaseForm(<?= $BaseItemDetails[0]->PK_BaseId ?>)">
                <img src="<?php echo asset_url() ?>dist/images/icons/dark/settings.png" alt="">
            </a>
            <a href="javascript:void(0);" class="tipS" original-title="Update" title="TOPPING LIST" onclick="hideListSegment(<?= $BaseItemDetails[0]->PK_BaseId ?>)">
    ...
    if( isset($arrToppList) && is_array($arrToppList) ) {
        ...
        <div class="pInfo" style="margin-top: 25px; color: red; text-align: center; width: 100%;" >
            <b>
                No Topping Found.
                <a href="javascript:void(0);" onclick="loadToppingBaseForm(<?= $BaseItemDetails[0]->PK_BaseId ?>)" >CLICK HERE</a> To Add New Topping.
            </b>
        </div>
        <?php
    }
