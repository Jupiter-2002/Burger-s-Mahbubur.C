...
<fieldset>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        ...
                        if( isset($arrCategoryList) && count($arrCategoryList) > 0 ) {
                            ?>
                            <select name="PK_SelecCatId" id="PK_SelecCatId" class="selectClass" >
                                <option value="" >Select Category</option>
                                <?php
                                foreach ( $arrCategoryList as $objCategory ) {
                                    ?>
                                    <option value="<?php echo $objCategory->PK_SelecCatId; ?>" ><?php echo $objCategory->SelecCatName; ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                        ...
                        <a href="javascript:void(0);"  title="" class="wButton greenwB" style="color: white; height: 24px; line-height: 24px; float: left; margin-left: 15px;" onclick="loadSelectionByCategoryForm(<?= $BaseItemDetails[0]->PK_BaseId;  ?>)" ><span>LOAD</span></a>

                        <a href="javascript:void(0);"  title="" class="wButton redwB" style="color: white; height: 24px; line-height: 24px; float: left; margin-left: 15px;" onclick="hideAddEditSegment(<?= $BaseItemDetails[0]->PK_BaseId;  ?>)" ><span>CLOSE</span></a>
                    </div>
                    <div class="clear"></div>
                </div>
                <?php
    ...
    <span id="spanSelectionList" name="spanSelectionList" style="width: 100%"></span>
</fieldset>
