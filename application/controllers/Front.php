...
class Front extends MY_Controller {
    ...
    public function info()	{
        ...
        //  Time Schedule Data
        $dataFrView['arrTimeScheduleOpening'] = $this->Front_model->timeSchedule("Opening");
        $dataFrView['arrTimeScheduleCollection'] = $this->Front_model->timeSchedule("Collection");
        $dataFrView['arrTimeScheduleDelivery'] = $this->Front_model->timeSchedule("Delivery");

        //////////////////////////////////////////////////////
        //      Setting Up View and Child View [ Start ]    //

        //  Template Related Segment [ Start ]
        $dataFrView['dataHead'] = $this->Front_model->getDataHead("|| Information");
        $dataFrView['dataHeader'] = $this->Front_model->getDataHeader();
        $dataFrView['dataNavigation'] = $this->Front_model->getDataNavigation();
        $dataFrView['dataFooter'] = $this->Front_model->getDataFooter();
        //  Template Related Segment [ End ]
        ...
        //  Main Content Related Segment [ Start ]
        $dataFrView['dataCurrentView'] = array();
        $dataFrView['currentView'] = "front/includes/info";
        //  Main Content Related Segment [ End ]
    ...
    public function contactUs() {
        ...
        //  Template Related Segment [ Start ]
        $dataFrView['dataHead'] = $this->Front_model->getDataHead("|| Contact Us");
        $dataFrView['dataHeader'] = $this->Front_model->getDataHeader();
        $dataFrView['dataNavigation'] = $this->Front_model->getDataNavigation();
        $dataFrView['dataFooter'] = $this->Front_model->getDataFooter();
        //  Template Related Segment [ End ]
        ...
        //  Main Content Related Segment [ Start ]
        $dataFrView['dataCurrentView'] = array();
        $dataFrView['currentView'] = "front/includes/contact_us";
        //  Main Content Related Segment [ End ]
