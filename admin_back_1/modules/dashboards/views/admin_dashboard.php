	...
	<div class="wrapper">
		<div class="controlB">
			<ul>
				...
				<li><a href="<?php echo base_url()."restaurant/restaurantList"; ?>" title=""><img src="<?php echo asset_url();?>dist/images/dashboard/bar-list.png" alt="" /><span>Restaurant List</span></a></li>
